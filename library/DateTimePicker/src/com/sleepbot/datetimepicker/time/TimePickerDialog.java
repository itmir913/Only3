...
public class TimePickerDialog extends DialogFragment implements RadialPickerLayout.OnValueSelectedListener {
    ...
    public interface OnTimeSetListener {
         ...
         */
        void onTimeSet(RadialPickerLayout view, int hourOfDay, int minute, int type);
    }
    ...
    public static TimePickerDialog newInstance(OnTimeSetListener callback,
                                               int hourOfDay, int minute, boolean is24HourMode, int type) {
        return newInstance(callback, hourOfDay, minute, is24HourMode, true, type);
    }

    public static TimePickerDialog newInstance(OnTimeSetListener callback,
                                               int hourOfDay, int minute, boolean is24HourMode, boolean vibrate, int type) {
        TimePickerDialog ret = new TimePickerDialog();
        ret.initialize(callback, hourOfDay, minute, is24HourMode, vibrate, type);
        return ret;
    }
    ...
    private void onDoneButtonClick() {
        ...
        if (mCallback != null) {
            mCallback.onTimeSet(mTimePicker,
                    mTimePicker.getHours(), mTimePicker.getMinutes(), mType);
        }
        dismiss();
    }
